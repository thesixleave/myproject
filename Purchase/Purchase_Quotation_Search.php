  ...
  <body>
    ...
    <nav class="navbar">
      <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a>詢價</a></li>
        ...
        <div class="col-lg-3">
          ...
          <a href="./Purchase_Quotation_Add.php" class="btn btn-primary btn-sm">
    ...
    <div class="container">
      ...
      <div class='row'>
        <div class='col-lg-3'>
          <div class='input-group'>
            <span class='input-group-addon'>詢價編號</span>
            <input type='text' class='form-control' placeholder='Order ID'>
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class='col-lg-3'>
          <div class='input-group'>
            <span class='input-group-addon'>詢價日期</span>
