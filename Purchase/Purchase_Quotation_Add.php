  ...
  <body>
    ...
    <nav class="navbar">
      <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a>報價</a></li>
        ...
        <div class="col-lg-3">
          <a href="./Purchase_Quotation_Search.php" class="btn btn-primary btn-sm">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="input-group">
            <span class="input-group-addon">供應商電話</span>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="input-group">
            <span class="input-group-addon">報價編號</span>
            <input type="text" class="form-control" placeholder="Quote ID">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-4">
          <div class="input-group">
            <span class="input-group-addon">報價日期</span>
            <input type="text" class="form-control" placeholder="2016/01/01">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-4">
          <div class="input-group">
            <span class="input-group-addon">報價有效日</span>
            <input type="text" class="form-control" placeholder="2016/02/01">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
      </div><!-- /.row -->
      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td><input type="text" class="form-control" placeholder="月桂" ></td>
            <td><input type="text" class="form-control" placeholder="2" name="Qty[]"></td>
            <td><input type="text" class="form-control" placeholder="KG"></td>
            <td><input type="text" class="form-control" placeholder="500" name="UnitPrice[]"></td>
            <td><input type="text" class="form-control" placeholder="0.1" name="Discount[]"></td>
            <td><input type="text" class="form-control" placeholder="0.05" name="Tax[]"></td>
...
<!-- Haven't changed below for javascript start  -->
          ...
          <tr>
            <td>2</td>
            <td><input type="text" class="form-control" placeholder="00002" name="Product_id[]"></td>
            <td><input type="text" class="form-control" placeholder="肉桂"></td>
            <td><input type="text" class="form-control" placeholder="1" name="Qty[]"></td>
            <td><input type="text" class="form-control" placeholder="KG"></td>
            <td><input type="text" class="form-control" placeholder="600" name="UnitPrice[]"></td>
            <td><input type="text" class="form-control" placeholder="0.1" name="Discount[]"></td>
            <td><input type="text" class="form-control" placeholder="0.05" name="Tax[]"></td>
            <td><input type="text" class="form-control" placeholder="" name="Remarks[]"></td>
          </tr>
          <tr>
            <td>3</td>
            <td><input type="text" class="form-control" placeholder="00003" name="Product_id[]"></td>
            <td><input type="text" class="form-control" placeholder="丁香"></td>
            <td><input type="text" class="form-control" placeholder="1" name="Qty[]"></td>
            <td><input type="text" class="form-control" placeholder="KG"></td>
            <td><input type="text" class="form-control" placeholder="600" name="UnitPrice[]"></td>
            <td><input type="text" class="form-control" placeholder="0.1" name="Discount[]"></td>
          ...
          <tr>
            ...
            <td><input type="text" class="form-control" placeholder=""></td>
            <td><input type="text" class="form-control" placeholder="" name="UnitPrice[]"></td>
            <td><input type="text" class="form-control" placeholder="" name="Discount[]"></td>
            <td><input type="text" class="form-control" placeholder="" name="Tax[]"></td>
            <td><input type="text" class="form-control" placeholder="" name="Remarks[]"></td>
          </tr>
          <tr>
            <td>5</td>
...
<!-- Haven't changed below for javascript end  -->
      ...
      <div class="col-lg-3">
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="2310" id="totalamount">
        </div><!-- /input-group -->
      </div><!-- /.col-lg-6 -->
