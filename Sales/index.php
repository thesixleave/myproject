...
if(isset($_POST['login'])){
    ...
    if(!$row){
        ...
        if ($result) {
                ...
                //echo "<div class='alert alert-success' role='alert'>登入成功!</div></br>";
        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse navbar-inverse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="../index.php" class="btn btn-secondary btn-sm" disabled><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> 使用者登入</a></li>
                    <li><a href="./register.php" class="btn btn-secondary btn-sm"><span class="glyphicon glyphicon-registration-mark" aria-hidden="true"></span> 註冊帳號</a></li>
                    <li><a href="./admin/login.php" class="btn btn-secondary btn-sm"><span class="glyphicon glyphicon-flag" aria-hidden="true"></span> 管理者登入</a></li>
                </ul>
