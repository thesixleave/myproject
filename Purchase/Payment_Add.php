  ...
  <body>
    ...
    <nav class="navbar">
      <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a>付款</a></li>
        <li role="presentation"><a href="./Reject_Add.php">退貨</a></li>
        <div class="col-lg-3">
          <a href="./Payment_Search.php" class="btn btn-primary btn-sm">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">付款總金額</span>
        ...
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">收貨編號</span>
