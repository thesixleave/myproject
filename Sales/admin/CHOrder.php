        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse navbar-inverse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="../../Items/Item_Add.php" class="btn btn-secondary btn-sm"><span class="glyphicon glyphicon-asterisk" aria-hidden="true"></span> 管理訂單</a></li>
  ...
  <form method="post">
    ...
    <?php
		...
		<div class='row'></div>
            ...
            <div class='col-xs-2'>總金額：$Total</div>
