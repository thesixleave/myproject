  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">訂單總金額</span>
        ...
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">出貨編號</span>
            <input type="text" class="form-control" placeholder="Deli ID">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">發票號碼</span>
            <input type="text" class="form-control" placeholder="Receipt ID">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
      </div><!-- /.row -->
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">發票日期</span>
            <input type="text" class="form-control" placeholder="Invoice Date">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-3">
          <div class="btn-group">
            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 付款方式 <span class="caret"></span>
            </button>
